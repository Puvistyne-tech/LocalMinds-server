...
export class CreateUserDto {
  ...
  @ApiProperty({ example: new Date(), description: 'Created at', required: false })
  @IsDate()
  @IsOptional()
  created_at?: Date;

  @ApiProperty({ example: new Date(), description: 'Last login', required: false })
  @IsDate()
  @IsOptional()
  last_login?: Date;
  ...
  @ApiProperty({ example: 'Bio text here', description: 'User bio', required: false })
  @IsString()
  @IsOptional()
  bio?: string;

  @ApiProperty({ example: 'avatar-url', description: 'User avatar URL', required: false })
  @IsString()
  @IsOptional()
  avatar?: string;
}
